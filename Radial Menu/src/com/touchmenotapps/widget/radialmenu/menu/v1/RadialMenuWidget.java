...
public class RadialMenuWidget extends View {
	...
	private boolean dismissOuterTouch = false;
	...
	public boolean isDismissOuterTouch() {
		return dismissOuterTouch;
	}

	public void setDismissOuterTouch(boolean dismissOuterTouch) {
		this.dismissOuterTouch = dismissOuterTouch;
	}

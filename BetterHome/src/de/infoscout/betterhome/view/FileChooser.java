...
public class FileChooser {
    ...
    public FileChooser(Activity activity, String initialFolder) {
        ...
        if (initialFolder == null) {
        	...
        	String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + initialFolder;
    ...
    private void refresh(File path) {
        ...
        if (path.exists()) {
            ...
            int i = 0;
            String[] fileList;
            int dirsCount = dirs == null ? 0 : dirs.length;
            int filesCount = files == null ? 0 : files.length;
            if (path.getParentFile() == null) {
                fileList = new String[dirsCount + filesCount];
            } else {
                fileList = new String[dirsCount + filesCount + 1];

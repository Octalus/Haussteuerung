...
public class CommandBuilder {
		...
		if (cmd.equals("get_config_info")) {
			...
			b.path("control").appendQueryParameter("callback", "cname")
					//.appendQueryParameter("cmd", "subscribe").appendQueryParameter("format", "htxt");
					  .appendQueryParameter("cmd", "subscribe").appendQueryParameter("format", "txt");
			return b.build();
		}
	...
	public static Uri buildUri(String[] data, String num, String cmd) {
		...
		if (cmd.equals("add_actuator")) {
			...
			b.path("control")
					...
					.appendQueryParameter("address", data[5]).appendQueryParameter("initvalue", "100").appendQueryParameter("function1.dsc", data[6])
	...
	public static Uri buildUri(String num, String cmd) {
		...
		else if (cmd.equals("get_config_timer")) {
			Uri.Builder b = Uri.parse("http://" + ip).buildUpon();
			b.path("control").appendQueryParameter("callback", "cname").appendQueryParameter("cmd", "get_config_timer")
					.appendQueryParameter("number", num);
			return b.build();
		}
		
		else if (cmd.equals("get_config_script")) {
			Uri.Builder b = Uri.parse("http://" + ip).buildUpon();
			b.path("control").appendQueryParameter("callback", "cname").appendQueryParameter("cmd", "get_config_script")
					.appendQueryParameter("number", num);
			return b.build();
		}
	 ...
	 * @return Uri
	 */
	public static Uri buildUri(String num, String cmd, String fromTime, String toTime) {
		if (cmd.equals("get_states_sensor")) {
			Uri.Builder b = Uri.parse("http://" + ip).buildUpon();
			b.path("control").appendQueryParameter("callback", "cname").appendQueryParameter("cmd", "get_state_sensor")
					.appendQueryParameter("sutime", fromTime)
					.appendQueryParameter("eutime", toTime)
					.appendQueryParameter("number", num);
			return b.build();
		}
		
		if (cmd.equals("get_states_actuator")) {
			Uri.Builder b = Uri.parse("http://" + ip).buildUpon();
			b.path("control").appendQueryParameter("callback", "cname").appendQueryParameter("cmd", "get_state_actuator")
					.appendQueryParameter("sutime", fromTime)
					.appendQueryParameter("eutime", toTime)

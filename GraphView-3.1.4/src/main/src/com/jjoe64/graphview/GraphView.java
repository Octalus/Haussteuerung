...
abstract public class GraphView extends LinearLayout {
	...
	private class GraphViewContentView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			Typeface tempTypeFace = paint.getTypeface();
			
			paint.setTextSize(tempTextSize + titleSize);
			...
			if (showBigValue) drawBigValue(canvas, bigValue, bigValueTextColor, bigValueShadowColor);
		}
		
		private void drawBigValue(Canvas canvas, String bigValue, int textColor, int shadowColor) {
			Paint paintText = new Paint(Paint.ANTI_ALIAS_FLAG);
			paintText.setColor(textColor);
			paintText.setTextSize(40);
			paintText.setTextAlign(Paint.Align.CENTER);
			paintText.setStyle(Style.FILL);
			paintText.setShadowLayer(10f, 10f, 10f, shadowColor);

			Rect rectText = new Rect();
			paintText.getTextBounds(bigValue, 0, bigValue.length(), rectText);
			int width = canvas.getWidth();
			int height = canvas.getHeight();
			//canvas.drawText(bigValue, (float)(0.5 * width + (0.06*width) ), (float)(height - (0.7 * height)), paintText);
			canvas.drawText(bigValue, (float)(0.5 * width), (float)(height - (0.7 * height)), paintText);
		}
    ...
    private boolean showBigValue = false;
    private String bigValue = "-1";
    private int bigValueTextColor = -1;
    private int bigValueShadowColor = -1;
	...
	public boolean isShowBigValue() {
		return showBigValue;
	}

	public void setShowBigValue(boolean showBigValue) {
		this.showBigValue = showBigValue;
	}
	...
	public int getBigValueTextColor() {
		return bigValueTextColor;
	}

	public void setBigValueTextColor(int bigValueTextColor) {
		this.bigValueTextColor = bigValueTextColor;
	}

	public int getBigValueShadowColor() {
		return bigValueShadowColor;
	}

	public void setBigValueShadowColor(int bigValueShadowColor) {
		this.bigValueShadowColor = bigValueShadowColor;
	}
